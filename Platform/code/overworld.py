...
class Overworld:
	...
	def input(self):
		...
		if self.current_node and not self.icon.path:
			if keys[pygame.K_DOWN or pygame.K_s] and self.current_node.can_move('down'):
				self.move('down')
			if keys[pygame.K_LEFT or pygame.K_a] and self.current_node.can_move('left'):
				self.move('left')
			if keys[pygame.K_RIGHT or pygame.K_d] and self.current_node.can_move('right'):
				self.move('right')
			if keys[pygame.K_UP or pygame.K_w] and self.current_node.can_move('up'):
				self.move('up')
